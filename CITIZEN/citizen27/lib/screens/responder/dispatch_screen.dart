    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      if (unit == null) {
        ...
        if (roster != null) {
          ...
          final ok = await provider.registerUnit(unit);
          if (!ok && mounted) {
      ...
      if (navUnit == null) {
        ...
        if (roster != null) {
          ...
          final ok = await provider.registerUnit(navUnit);
          if (!ok && mounted) {
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(
                content: Text('This unit is not In service yet.'),
                        ...
                        children: [
                            ...
                            children: [
                              ...
                              Expanded(
                                child: FilledButton.icon(
                                  ...
                                  onPressed: () => _confirmCompleteFromDispatch(
                                      context, provider, activeForUnit),
                          ...
                          SizedBox(
                            ...
                            child: TextButton.icon(
                              onPressed: () => _confirmAbortFromDispatch(
                                  context, provider, activeForUnit),
