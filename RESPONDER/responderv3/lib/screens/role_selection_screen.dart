...
import 'responder/unit_login_screen.dart';

/// Landing screen where the user selects their role.
/// In production, this would be replaced with proper authentication.
class RoleSelectionScreen extends StatelessWidget {
  static const bool _responderOnlyMode = true;
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Responder-Only Application Version',
                  style: TextStyle(
                    ...
                    onTap: () async {
                      ...
                      if (selectedMode != null) {
                        ...
                        if (selectedMode == CitizenAccessMode.registered) {
                          final controller = TextEditingController(text: provider.citizenEmail ?? '');
                          email = await showDialog<String>(
                            context: context,
                            builder: (ctx) => AlertDialog(
                              title: const Text('Registered account email'),
                              content: TextField(
                        ...
                        await provider.setCitizenAccessMode(selectedMode, email: email);
                      }
                ...
                _RoleCard(
                  ...
                  title: 'Responder',
                  subtitle: 'Receive dispatches & navigate',
                  color: Colors.green,
                  onTap: () {
                    final provider = context.read<RescueProvider>();
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (_) => const UnitLoginScreen(),
                      ),
                    );
                  },
                ),
